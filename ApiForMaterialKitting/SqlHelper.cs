...
namespace ApiForMaterialKitting
{
    public class SqlHelper
    {
        //连接字符串
        //1、添加引用 2、导入命名空间 为了使用ConfigurationManager
        public static string conStr = ConfigurationManager.ConnectionStrings["ApiForMaterialKitting.Properties.Settings.SlotKBConnectionString"].ConnectionString;
