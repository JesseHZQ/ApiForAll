...
namespace ApiForFCTKBNew.Job
{
    public class MailWithFile : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            string UFPath = rc.generateExcel("UF");
            string IFPath = rc.generateExcel("IF");
            string DPath = rc.generateExcel("D");
            int day = -1;
            ...
            mess.Subject = string.Format("FCT System Status WK{0} (Testing...)", Tool.WeekOfYear(DateTime.Now).ToString() + "." + day.ToString());
            ...
            mess.CC.Add("shaffick_ali@notes.teradyne.com");
            mess.CC.Add("Tony_Liu@notes.teradyne.com");
            mess.CC.Add("eric.zhou@teradyne.com");
